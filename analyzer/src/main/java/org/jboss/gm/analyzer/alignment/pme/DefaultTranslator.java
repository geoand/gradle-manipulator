...
public class DefaultTranslator
     ...
     */
    public Map<ProjectVersionRef, Value> translateVersions(List<ProjectVersionRef> projects) {
        init(rgm);

        final Map<ProjectVersionRef, Value> result = new HashMap<>();
    ...
    private class Task {
        ...
        private Map<ProjectVersionRef, Value> result = null;
        ...
        public Map<ProjectVersionRef, Value> getResult() {
            return result;
        }
